...
<div class="layui-nav" lay-filter="test">
    <ul class="layui-nav-title">
        ...
        <li class="layui-nav-item layui-this"><a href="">药品APP用户管理</a></li>
    ...
    layui.use('table', function () {
        ...
        var usetable = table.render({
            ...
            , cols: [[ //表头
                ...
                , {field: 'phoneNumber', title: '手机号', sort: true, width: 200}
                , {field: 'headImage_url', title: '头像图片名'}
        ...
        table.on('tool(user)', function (obj) { //注：tool是工具条事件名，test是table原始容器的属性中的lay-filter="对应的值"
            ...
            if (layEvent === "detail") { //查看
                var index = layer.open({
                    ...
                    content: "getOrderByUid?uid=" + data.id //获取id值
                    , end: function () {
                        usetable.reload({
                            page: {
                                curr: 1 //重新从第 1 页开始
            ...
            if (obj.event === 'edit') {//监听编辑
                var index = layer.open({
                    ...
                    method: 'POST',
                    skin: 'layui-layer-rim',
                    content: "updateMedUser?uid=" + data.id //获取id值
                    , end: function () {
                        usetable.reload({
                            page: {
                                curr: 1 //重新从第 1 页开始
