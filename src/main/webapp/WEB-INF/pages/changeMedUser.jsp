...
<%--lay-filter="example"--%>
<form class="layui-form" action="changeMedUser"  method="post">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" name="phoneNumber" placeholder="请输入手机号" lay-verify="" autocomplete="off" class="layui-input">
        </div>
    </div>
